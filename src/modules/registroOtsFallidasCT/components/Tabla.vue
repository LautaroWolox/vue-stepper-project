      ...
      <div class="fallidas-footer">
        <div class="footer-left">
          ...
          <button class="footer-icon footer-icon-delete" title="Excluir seleccionadas" aria-label="Excluir seleccionadas" @click="$emit('exclude')">
            <svg class="fm-svg-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M5 7h14"></path><path d="M9 7V4.8h6V7"></path><path d="M7 7l.8 13h8.4L17 7"></path><path d="M10 11v5.5"></path><path d="M14 11v5.5"></path></svg>
          </button>
          <button class="footer-icon footer-icon-refresh" title="Reprocesar" aria-label="Reprocesar" @click="$emit('process')">
            <svg class="fm-svg-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M7.2 8.1A6.7 6.7 0 0 1 18.4 11"></path><path d="M18.4 6.3V11h-4.7"></path><path d="M16.8 15.9A6.7 6.7 0 0 1 5.6 13"></path><path d="M5.6 17.7V13h4.7"></path></svg>
          </button>
        </div>
