...
const columns = reactive([
  { field: 'nroOt', label: 'NRO OT', width: '110px', minWidth: '90px', visible: true },
  { field: 'estadoFm', label: 'ESTADO FM', width: '120px', minWidth: '95px', visible: true },
  { field: 'codMaterial', label: 'COD MATERIAL', width: '150px', minWidth: '120px', visible: true },
  { field: 'nombreMaterial', label: 'NOMBRE MATERIAL', width: '180px', minWidth: '150px', visible: true },
  { field: 'tipoMaterial', label: 'TIPO MATERIAL', width: '180px', minWidth: '140px', visible: true },
  { field: 'cantidad', label: 'CANTIDAD', width: '100px', minWidth: '80px', visible: true },
  { field: 'tipoDescarga', label: 'TIPO DESCARGA', width: '130px', minWidth: '110px', visible: true },
  { field: 'descripcionError', label: 'DESCRIPCION ERROR', width: '185px', minWidth: '150px', visible: true },
  { field: 'codCentro', label: 'COD CENTRO', width: '160px', minWidth: '120px', visible: true },
  { field: 'centro', label: 'CENTRO', width: '100px', minWidth: '80px', visible: true },
  { field: 'codAlmacen', label: 'COD ALMACEN', width: '170px', minWidth: '130px', visible: true },
  { field: 'almacen', label: 'ALMACEN', width: '100px', minWidth: '80px', visible: true },
  { field: 'operadorDescarga', label: 'OPERADOR DESCARGA', width: '210px', minWidth: '170px', visible: true },
  { field: 'fechaDescarga', label: 'FECHA DESCARGA', width: '175px', minWidth: '140px', visible: true },
  { field: 'operadorUltMod', label: 'OPERADOR ULT MOD', width: '195px', minWidth: '160px', visible: true },
  { field: 'fechaUltMod', label: 'FECHA ULT MOD', width: '165px', minWidth: '135px', visible: true },
  { field: 'codigoPostal', label: 'CODIGO POS', width: '100px', minWidth: '85px', visible: true },
  { field: 'materialValidado', label: 'MATERIAL VALIDADO', width: '200px', minWidth: '160px', visible: true },
  { field: 'codTarea', label: 'COD TAREA', width: '110px', minWidth: '90px', visible: true }
])
