...
const menuList = ref([
  ...
  { title: 'Certificación Contratista', submenus: [
    ...
    { id: 103, label: 'Gestión de Actas', mobileExpanded: false, children: [
      { id: 1031, label: 'Consultar Actas', action: 'consultar-actas' },
      { id: 1032, label: 'Consultar Notas de Crédito', action: 'consultar-nota-credito' },
      { id: 1033, label: 'Consultar Notas de Debito', action: 'consultar-nota-debito' }
    ] },
    { id: 104, label: 'Parametrizaciones', mobileExpanded: false, children: [
