...
.notas-grid { width: max-content; min-width: 100%; border-collapse: collapse; table-layout: fixed; font-size: 12px; }
.notas-grid th, .notas-grid td { border-right: 1px solid #c9d3da; border-bottom: 1px solid #dce3e8; padding: 7px 8px; text-align: left; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.notas-grid thead th { position: sticky; background: #f4f7f9; color: #2c4050; font-weight: 600; font-size: 11px; z-index: 5; }
...
.notas-grid tbody tr { cursor: pointer; }
.notas-grid tbody tr:hover td { background: #edfafd; }
.notas-grid tbody tr.selected td { background: #9eeff7; color: #003f47; }
.empty-cell { text-align: center !important; padding: 34px !important; color: #607d8b; }
.note-link, .acta-link { color: #00a9bd; font-weight: 700; cursor: pointer; }
...
<style>
body.notas-column-resizing, body.notas-column-resizing * { cursor: col-resize !important; user-select: none !important; }
</style>
