  ...
  <div class="detalle-nota-view">
    ...
    <section class="fm-box">
      ...
      <div v-show="openOrdenes" class="fm-box-content grid-section">
        ...
        <div class="bottom-actions"><button class="btn-cyan" @click="exportFullNotaExcel">EXPORTAR NOTA DE {{ notaTipoUpper }}</button><button class="btn-cyan" @click="showConfirm = true">VALIDAR ACTIVIDADES</button></div>
      </div>
    </section>
...
defineEmits(['volver'])
const openDetalle = ref(true), openOrdenes = ref(true), showOt = ref(false), showConfirm = ref(false), showSuccess = ref(false)
