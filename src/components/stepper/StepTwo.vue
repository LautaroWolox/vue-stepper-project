<template>
  <div class="step-two">
    ...
    <div v-else style="padding: 20px; text-align: center; color: #90a4ae; border: 2px dashed #cfd8dc; border-radius: 8px;">
      ...
      <p>No hay datos seleccionados en el Paso 1.</p>
    </div>

    <div class="export-container">
      <button class="btn" :disabled="selectedData.length === 0" @click="exportCSV">
        <span class="material-icons btn-icon">file_download</span> Exportar Seleccionados a CSV
      </button>
    </div>
  </div>
</template>
